...
function sendPasswordResetEmail($userEmail, $resetCode)
{
    ...
    try {
        ...
        $mail->Body    = '
                        ...
                        <p><a href="http://localhost:3000/reset_password.php?code=' . $resetCode . '">Trocar senha</a></p>
                        <p>Caso você não tenha feito essa solicitação, você pode ignorá-la. Caso ache que a sua conta esteja em perigo, entre em contato com o <a href="http://localhost:3000/contact.php">Suporte ao Cliente</a>.</p>
                        <p>Atenciosamente,</p>
                        <p>本屋くん</p>
                    ';
